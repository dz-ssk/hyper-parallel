...
日期：2026-09-21。本文保留迁移前的接口设计，下面的“计划、待验证”描述属于设计阶段，不代表当前完成状态。首 loss 前向适配现已完成：256K、8 卡下总 loss 为 8.117478370666504，与参考保存的首步结果逐位一致。最新实现、逐模块 commit 和验证边界见 [首 loss 对齐报告](HF_FIRST_LOSS_REPORT.md)。反向、优化器更新及多步仍待验证。
